...
export const APPEARANCE_FORM_SCHEMA: HaFormSchema[] = [
  {
    ...
    name: "",
    schema: [
      { name: "layout", selector: { plasma_layout: {} } },
  ...
  },
  {
    ...
    name: "",
    schema: [
      { name: "primary_info", selector: { plasma_info: {} } },
      { name: "secondary_info", selector: { plasma_info: {} } },
      { name: "icon_type", selector: { plasma_icon_type: {} } },
    ],
  },
];
