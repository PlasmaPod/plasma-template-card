...
export class Card extends LitElement {
  ...
  static get styles(): CSSResultGroup {
    return css`
      ...
      .container > ::slotted(plasma-state-item) {
        flex: 1;
      }
      .container.horizontal.no-info > ::slotted(plasma-state-item) {
        flex: none;
      }
      .container.no-content > ::slotted(plasma-state-item) {
        display: none;
      }
